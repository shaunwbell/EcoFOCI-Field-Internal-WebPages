...
$nav_array = array(
array("Home","../eFOCI_Drifters/index.php",0),
array("Drifter Records","#",1),
array("Drifter 2015 and later","../eFOCI_Drifters/DrifterStatus.php",2),
array("Drifter pre-2015","../eFOCI_Drifters/DrifterStatus_Archive.php",3),
array("Drifter Quicklooks","../eFOCI_Drifters/DrifterQuicklooksLanding.php",0),
array("Add/Update Drifter ID","../eFOCI_Drifters/RecordUpdate.php",0),
array("Current Drifters (last 14 days)","../eFOCI_Drifters/erddap_drifters_last14days.php",0),
array("README","../eFOCI_Drifters/ArgosDrifter_README.html",0)
);
