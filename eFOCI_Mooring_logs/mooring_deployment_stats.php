...
<title>Mooring Deployment Stats and Summary</title>
<!-- Bootstrap theme -->
...
<!-- Static navbar -->
<?php build_navbar("Mooring Deployment Stats and Summary") ?>
...
<h3>Mooring Instrument Stats and Summary</h3>   

<?php instsummary_select() ?>
