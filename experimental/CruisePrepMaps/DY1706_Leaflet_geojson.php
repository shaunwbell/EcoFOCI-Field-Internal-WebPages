...
<div id="mapid" style="width: 100%; height: 100%"></div>
    ...
    <script>
        ...
        var geojsonLayer = new L.GeoJSON.AJAX("<?php echo 'DY1706.geojson'?>", {
        ...
        var geojsonLayer = new L.GeoJSON.AJAX("<?php echo 'DY1706_ctdonly.geojson'?>", {
            pointToLayer: function (feature, latlng) {
        ...
        var geojsonLayer = new L.GeoJSON.AJAX("<?php echo 'DY1706_floats.geojson'?>", {
            pointToLayer: function (feature, latlng) {
        ...
        var geojsonLayer = new L.GeoJSON.AJAX("<?php echo 'DY1706_moorings.geojson'?>", {
            pointToLayer: function (feature, latlng) {
        ...
        var geojsonLayer = new L.GeoJSON.AJAX("<?php echo 'DY1706_calvets.geojson'?>", {
            pointToLayer: function (feature, latlng) {
        ...
        legend.onAdd = function (map) {
            ...
            var div = L.DomUtil.create('div', 'info legend'),
                categories = ['Moorings','Floats','CTD/BON','CTD','Calvets'];
