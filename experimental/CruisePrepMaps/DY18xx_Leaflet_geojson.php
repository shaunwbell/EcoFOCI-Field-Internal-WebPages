...
<div id="mapid" style="width: 100%; height: 100%"></div>
    ...
    <script>
        ...
        var geojsonLayer = new L.GeoJSON.AJAX("<?php echo 'DY18xx.geojson'?>", {
        ...
        var geojsonLayer = new L.GeoJSON.AJAX("<?php echo 'DY18xx_ctdonly.geojson'?>", {
            pointToLayer: function (feature, latlng) {
        ...
        var geojsonLayer = new L.GeoJSON.AJAX("<?php echo 'DY18xx_moorings.geojson'?>", {
            pointToLayer: function (feature, latlng) {
        ...
        var geojsonLayer = new L.GeoJSON.AJAX("<?php echo 'DY18xx_calvets.geojson'?>", {
            pointToLayer: function (feature, latlng) {
        ...
        var geojsonMarkerOptions_Glider = {
            radius: 4,
            fillColor: "#FFFF00",
            color: "#ffffff",
            weight: .2,
        ...
        var geojsonLayer = new L.GeoJSON.AJAX("<?php echo 'DY18xx_gliders.geojson'?>", {
            pointToLayer: function (feature, latlng) {
                return L.circleMarker(latlng, geojsonMarkerOptions_Glider);
            },
            onEachFeature: function (feature, layer) {
            layer.bindPopup(feature.properties.FIELD1 + ' ' + feature.properties.FIELD2);
            }
        ...
        legend.onAdd = function (map) {
            ...
            var div = L.DomUtil.create('div', 'info legend'),
                categories = ['Moorings','CTD/BON','CTD','Calvets','Glider'];
