...
array("Status","index.php",0),
array("Instrumentation","instruments.php",0),
array("Calibrations","calibrations.php",0),
array("Operations","operations.php",0),
array("Add New Records","newrecord.php",0),
);
